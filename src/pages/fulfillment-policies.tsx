  ...
  return (
    <Page>
      ...
      <ul>
        ...
        <li>
          <b>Maintenance & Support:</b> We offer ongoing maintenance and support services to ensure
          your website or web application remains secure and up-to-date. We will provide regular
          updates and address any issues promptly to maintain optimal performance.
        </li>
        <li>
        ...
        <li>
          <b>Timeframes:</b> Estimated project timelines vary depending on the scope and complexity
          of the project. We will provide you with a detailed timeline during the project scoping
          phase. We will communicate any unforeseen delays or adjustments to the timeline as they
          arise.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <b>After Work Commences:</b> If you request a cancellation after work has begun, you will
          be billed for the work completed up to that point. Refunds are not typically offered for
          completed work, but we are committed to resolving any issues or concerns you may have.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          time. If you cancel before the end of the billing cycle, you will not be refunded for the
