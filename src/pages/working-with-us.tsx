...
export default function FulfillmentPolicy(): JSX.Element {
  return (
    <Main>
      ...
      <h3>1. Project Scoping & Agreement:</h3>
      <ul>
        <li>We will collaborate to define your project scope, objectives, and timeline.</li>
        <li>You will receive a detailed proposal outlining deliverables, milestones, and costs.</li>
        <li>
          Once you approve the proposal, we&apos;ll finalize a formal agreement detailing the
          project terms and conditions.
        </li>
      </ul>
      <h3>2. Development & Delivery:</h3>
      <ul>
        <li>
      ...
      <h3>3. Ongoing Support & Maintenance:</h3>
      <ul>
        <li>
      ...
      <h3>4. Confidentiality & Data Security:</h3>
      <ul>
        <li>
          We take data security and confidentiality seriously. Any information shared with us during
          the project will be handled with the utmost care and protection.
        </li>
        <li>
        ...
        <li>
          We are usually happy to sign a non-disclosure agreement (NDA) to protect your intellectual
          property and proprietary information. Please let us know if you require an NDA.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          If you are dissatisfied with our services, please contact us to discuss your concerns and
          potential resolutions.
        </li>
      </ul>
      <h3>7. Client Satisfaction:</h3>
      <ul>
        <li>
